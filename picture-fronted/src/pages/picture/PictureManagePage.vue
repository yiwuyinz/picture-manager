<template>
  <a-flex justify="space-between">
    <a-flex :gap="8">
      ...
      <a-button type="link" style="font-size: 24px; margin-bottom: 16px;">图片管理</a-button>
    </router-link>
    <router-link to="/admin/pictureReview">
      <a-button type="link" style="font-size: 24px; margin-bottom: 16px;">图片审核</a-button>
    </router-link>
    </a-flex>
    <a-space>
      <a-button type="primary" href="/add_picture" target="_blank" style="font-size: 16px;">+ 创建图片</a-button>
      <a-button type="primary" href="/add_picture/batch" target="_blank" style="font-size: 16px;">+ 批量创建图片</a-button>
    </a-space>
  </a-flex>
