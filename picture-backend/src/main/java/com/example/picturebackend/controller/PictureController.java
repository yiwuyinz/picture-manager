...
import com.example.picturebackend.manager.auth.StpKit;
import com.example.picturebackend.manager.auth.annotation.SaSpaceCheckPermission;
...
public class PictureController {
    ...
    public BaseResponse<PictureVO> getPictureVOById(long id, HttpServletRequest request) {
        ...
        if (spaceId != null) {
            boolean hasPermisson = StpKit.SPACE.hasPermission(SpaceUserPermissionConstant.PICTURE_VIEW);
            ThrowUtils.throwIf(!hasPermisson, ErrorCode.NO_AUTH_ERROR);
