...
import com.example.picturebackend.manager.sharding.DynamicShardingManager;
...
public class SpaceServiceImpl extends ServiceImpl<SpaceMapper, Space>
            ...
            Long newSpaceId = transactionTemplate.execute(status -> {
                ...
                if (spaceType == SpaceTypeEnum.PRIVATE.getValue()) {
                    ...
                    if (!userService.isAdmin(loginUser)) {
                        ThrowUtils.throwIf(exists, ErrorCode.OPERATION_ERROR, "每个用户仅能有一个团队空间");
                    }
                }
                // 写入数据库
    ...
    public void deleteSpace(DeleteRequest deleteRequest) {
        Space space = this.getById(deleteRequest.getId());
        ...
        boolean deleted = spaceUserService.remove(wrapper);
